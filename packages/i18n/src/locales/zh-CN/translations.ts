...
export default {
  ...
  requirement_pool_empty: "暂无待处理需求。请在项目中开启收集（Intake）以在此汇总。",
  requirement_pool_select_projects: "投递到以下开启收集的项目",
  requirement_pool_multi_labels_disabled_hint: "标签按项目区分。多项目同时投递时请在各项目收集队列中分别补充标签。",
  requirement_pool_multi_create_all_failed: "未能在任何选中项目中创建需求。",
  requirement_pool_multi_create_all_ok: "已在 {total} 个项目中创建需求。",
  requirement_pool_multi_create_partial: "已创建 {success}/{total} 个需求；{failed} 个失败（权限或项目设置）",
  bug_pool: {
    title: "Bug 池",
    description: "汇总已挂到父工作项下的子工作项（常用于缺陷）。点击行可进入对应项目的工作项。",
    empty: "暂无子工作项。请在工作项详情中通过「子工作项」在父任务下添加。",
    filter_project: "项目",
    all_projects: "全部项目",
    parent_work_item_hint: "父工作项",
  },
  projects: "项目",
  views: "视图",
  workspace: "工作区",
  ...
  end_date: "结束日期",
  due_date: "截止日期",
  initial_expected_due_date: "初始预期完成",
  evaluated_due_date: "评估后完成",
  confirmed_due_date: "确认截止",
  estimate: "估算",
  ...
  issue_batch_import: {
    title: "批量导入",
    nav: "批量导入",
    sample_heading: "JSON 样例",
    copy_sample: "复制样例",
    copy_success_title: "已复制",
    copy_success_message: "样例 JSON 已复制到剪贴板。",
    copy_error: "无法复制到剪贴板。",
    json_label: "粘贴 JSON",
    json_placeholder: '粘贴对象数组，或 { "items": [ ... ] }',
    parse: "解析",
    drafts_heading: "草稿预览",
    row_label: "第 {index} 条",
    skip_row: "跳过",
    publish: "发布",
    back_to_list: "返回工作项列表",
    no_default_state: "无法解析本项目的默认工作流状态，请待状态加载完成后重试。",
    nothing_to_publish_title: "无可发布项",
    nothing_to_publish_message: "所有行已跳过或列表为空。",
    publish_success: "已创建 {count} 个工作项",
    publish_error: "创建失败，请根据下方提示修正后重试。",
    empty_name_at: "第 {index} 条：标题不能为空。",
    apply_schedule_checkbox: "对未填日期的行应用 JSON 中的阶梯排期（schedule）",
    import_key_label: "导入键",
    parent_import_key_label: "父级导入键",
    parent_id_label: "父工作项 ID",
    start_date_label: "开始",
    target_date_label: "截止",
    missing_parent_import_key: "尚未创建导入键为「{key}」的父工作项，请检查解析顺序或跳过设置。",
  },
  attachments: "附件",
  declining: "拒绝中",
  declined: "已拒绝",
  ...
  profile: {
    ...
    work_report: {
      ...
      type_weekly: "周报",
      period_anchor: "日期",
      refresh_summary: "刷新汇总",
      auto_summary: "自动汇总",
      stats_completed: "已完成工作项",
      stats_created: "新建工作项",
      stats_activity: "活动条数",
      highlights: "近期动态",
      notes_label: "补充说明",
      notes_placeholder: "可填写总结、计划或协作说明…",
      save_notes: "保存说明",
