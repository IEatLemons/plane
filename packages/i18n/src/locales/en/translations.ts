...
export default {
  ...
  requirement_pool_empty: "No open requirements. Enable intake on a project to collect items here.",
  requirement_pool_select_projects: "Submit to projects (with intake enabled)",
  requirement_pool_multi_labels_disabled_hint:
    "Labels are per project. When submitting to multiple projects, add tags in each project's intake after items are created.",
  requirement_pool_multi_create_all_failed: "Could not create requirements in any selected project.",
  requirement_pool_multi_create_all_ok: "Created requirements in {total, plural, one {# project} other {# projects}}.",
  requirement_pool_multi_create_partial:
    "Created {success} of {total} requirements. {failed} failed (permission or project settings).",
  bug_pool: {
    title: "Bug pool",
    description:
  ...
  end_date: "End date",
  due_date: "Due date",
  initial_expected_due_date: "Initial expected due",
  evaluated_due_date: "Evaluated due",
  confirmed_due_date: "Confirmed due",
  estimate: "Estimate",
  ...
  issue_batch_import: {
    title: "Batch import",
    nav: "Batch import",
    sample_heading: "Sample JSON",
    copy_sample: "Copy sample",
    copy_success_title: "Copied",
    copy_success_message: "Sample JSON copied to clipboard.",
    copy_error: "Could not copy to clipboard.",
    json_label: "Paste JSON",
    json_placeholder: 'Paste an array of objects or { "items": [ ... ] }',
    parse: "Parse",
    drafts_heading: "Review drafts",
    row_label: "Item {index}",
    skip_row: "Skip",
    publish: "Publish",
    back_to_list: "Back to work items",
    no_default_state: "Could not resolve a default workflow state for this project. Try again after states load.",
    nothing_to_publish_title: "Nothing to publish",
    nothing_to_publish_message: "All rows are skipped or the list is empty.",
    publish_success: "{count, plural, one {# work item created} other {# work items created}}",
    publish_error: "Creation failed. Fix the issue below and try again.",
    empty_name_at: "Row {index}: title cannot be empty.",
    apply_schedule_checkbox: "Apply sequential schedule from JSON when dates are missing",
    import_key_label: "Import key",
    parent_import_key_label: "Parent key",
    parent_id_label: "Parent ID",
    start_date_label: "Start",
    target_date_label: "Due",
    missing_parent_import_key:
      'Parent work item for import key "{key}" was not created yet. Check row order and skip settings.',
  },
  ...
  workspace_settings: {
    ...
    settings: {
      ...
      members: {
        ...
        job_positions: {
          choose: "Choose positions",
          selected_suffix: "positions",
          labels: {
  ...
  profile: {
    ...
    work_report: {
      ...
      stats_completed: "Completed work items",
      stats_created: "Created work items",
      stats_activity: "Activities",
      highlights: "Recent activity",
      notes_label: "Notes",
      notes_placeholder: "Add context or plans…",
