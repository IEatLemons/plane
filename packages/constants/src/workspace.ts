...
export * from "./workspace-job-positions";
...
export const WORKSPACE_SIDEBAR_STATIC_NAVIGATION_ITEMS: Record<string, IWorkspaceSidebarNavigationItem> = {
  ...
  requirement_pool: {
    key: "requirement_pool",
    labelTranslationKey: "requirement_pool",
    href: `/requirement-pool/`,
    access: [EUserWorkspaceRoles.ADMIN, EUserWorkspaceRoles.MEMBER, EUserWorkspaceRoles.GUEST],
    highlight: (pathname: string, url: string) => pathname.includes(url),
  },
  bug_pool: {
    key: "bug_pool",
    labelTranslationKey: "sidebar.bug_pool",
    href: `/bug-pool/`,
    access: [EUserWorkspaceRoles.ADMIN, EUserWorkspaceRoles.MEMBER, EUserWorkspaceRoles.GUEST],
    highlight: (pathname: string, url: string) => pathname.includes(url),
  },
...
export const WORKSPACE_SIDEBAR_STATIC_NAVIGATION_ITEMS_LINKS: IWorkspaceSidebarNavigationItem[] = [
  ...
  WORKSPACE_SIDEBAR_STATIC_NAVIGATION_ITEMS["requirement_pool"],
  WORKSPACE_SIDEBAR_STATIC_NAVIGATION_ITEMS["bug_pool"],
];
