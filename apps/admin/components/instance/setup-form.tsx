...
import { API_BASE_URL, EAuthErrorCodes, EAdminAuthErrorCodes, E_PASSWORD_STRENGTH } from "@plane/constants";
...
import { authErrorHandler as adminAuthErrorHandler } from "@/app/(all)/(home)/auth-helpers";
...
export function InstanceSetupForm() {
  ...
  useEffect(() => {
    ...
    const adminDetail = adminAuthErrorHandler(errorCode as EAdminAuthErrorCodes);
    if (adminDetail) {
      setErrorInfo(adminDetail);
      return;
    }
    const generalDetail = authErrorHandler(errorCode as EAuthErrorCodes);
    setErrorInfo(generalDetail ?? undefined);
  }, [errorCode]);
          ...
          >
            ...
            <div className="w-full space-y-1">
              ...
              <Input
                ...
                hasError={errorCode === EAuthErrorCodes.INVALID_ADMIN_EMAIL}
                autoComplete="off"
              />
            </div>
            ...
            <div className="w-full space-y-1">
              ...
              <div className="relative">
                <Input
                  ...
                  hasError={
                    errorCode === EAuthErrorCodes.INVALID_ADMIN_PASSWORD ||
                    errorCode === EAuthErrorCodes.INVALID_PASSWORD ||
                    errorCode === EAuthErrorCodes.PASSWORD_TOO_WEAK
                  }
